    ...
    <div className="fixed inset-0 bg-opacity-20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-[550px] transition-all duration-200 overflow-hidden">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="stoplist-toggle" className="ml-2 block text-sm font-medium text-gray-700">
                    Enable Stopwords
                  </label>
                </div>
                <button
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                  />
                  <label htmlFor="whitelist-toggle" className="ml-2 block text-sm font-medium text-gray-700">
                    Enable Whitelist
                  </label>
                </div>
                <button
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 text-gray-800">Visualization</h4>
            ...
            <div className="flex items-center mt-4">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
              />
              <label htmlFor="applyGlobally" className="ml-2 block text-sm font-medium text-gray-700">
