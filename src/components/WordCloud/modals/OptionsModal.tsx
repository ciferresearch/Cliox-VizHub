    ...
    <div className="fixed inset-0 bg-opacity-20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-[550px] transition-all duration-200 overflow-hidden">
        <div className="px-8 py-3 bg-gray-50 dark:bg-gray-700 flex justify-between items-center">
          <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200">Word Cloud Options</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 text-gray-800 dark:text-gray-200">Word Filtering</h4>
              ...
              <div className="mt-3">
                ...
                <select
                  ...
                  className={`form-select block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm 
                            ...
                            ${!stoplistActive ? 'bg-gray-100 dark:bg-gray-600 text-gray-500 dark:text-gray-400 cursor-not-allowed opacity-75' : ''}`}
                  disabled={!stoplistActive}
            ...
            <div>
              ...
              {whitelistActive && (
                <div className="mt-2 text-xs text-green-600 dark:text-green-400">
                  Click "Edit List" to specify exactly which words should be shown.
                </div>
              )}
            </div>
          </div>
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 text-gray-800 dark:text-gray-200">Visualization</h4>
